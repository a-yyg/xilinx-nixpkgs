...
// Internal, version-checked, entry point.
WEBP_EXTERN(int)
WebPAnimEncoderOptionsInitInternal(WebPAnimEncoderOptions *, int);
...
WebPAnimEncoderOptionsInit(WebPAnimEncoderOptions *enc_options) {
...
//   Or NULL in case of memory error.
static WEBP_INLINE WebPAnimEncoder *
WebPAnimEncoderNew(int width, int height,
...
WEBP_EXTERN(int)
WebPAnimEncoderAdd(WebPAnimEncoder *enc, struct WebPPicture *frame,
...
//   True on success.
WEBP_EXTERN(int)
WebPAnimEncoderAssemble(WebPAnimEncoder *enc, WebPData *webp_data);
