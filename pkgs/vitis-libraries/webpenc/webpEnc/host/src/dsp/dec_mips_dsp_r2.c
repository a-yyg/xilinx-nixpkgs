...
static void TransformDC(const int16_t *in, uint8_t *dst) {
  ...
  __asm__ volatile(
      LOAD_WITH_OFFSET_X4(
          temp1, temp2, temp3, temp4, dst, 0, 0, 0, 0, 0, 1, 2, 3,
          BPS) "lh               %[temp5],  0(%[in])               \n\t"
               "addiu            %[temp5],  %[temp5],  4           \n\t"
               "ins              %[temp5],  %[temp5],  16, 16      \n\t"
               "shra.ph          %[temp5],  %[temp5],  3           "
               "\n\t" CONVERT_2_BYTES_TO_HALF(temp6, temp7, temp8, temp9,
                                              temp10, temp1, temp2, temp3,
                                              temp1, temp2, temp3, temp4)
                   STORE_SAT_SUM_X2(temp6, temp7, temp8, temp9, temp10, temp1,
                                    temp2, temp3, temp5, temp5, temp5, temp5,
                                    temp5, temp5, temp5, temp5, dst, 0, 1, 2, 3,
                                    BPS)
  ...
  __asm__ volatile(
      ...
      "\n\t" ADD_SUB_HALVES(
          ...
          c4) "replv.ph         %[temp5],   %[c1]                      "
              "\n\t" SHIFT_R_SUM_X2(temp1, temp6, temp7, temp8, temp2, temp9,
                                    temp10, temp4, temp2, temp2, temp3, temp3,
                                    temp4, temp5, temp4, temp5)
                  LOAD_WITH_OFFSET_X4(temp3, temp5, temp11, temp12, dst, 0, 0,
                                      0, 0, 0, 1, 2, 3, BPS)
                      CONVERT_2_BYTES_TO_HALF(temp13, temp14, temp3, temp15,
                                              temp5, temp16, temp11, temp17,
                                              temp3, temp5, temp11, temp12)
                          PACK_2_HALVES_TO_WORD(temp12, temp18, temp7, temp6,
                                                temp1, temp8, temp2, temp4,
                                                temp7, temp6, temp10, temp9)
                              STORE_SAT_SUM_X2(temp13, temp14, temp3, temp15,
                                               temp5, temp16, temp11, temp17,
                                               temp12, temp18, temp1, temp8,
                                               temp2, temp4, temp7, temp6, dst,
                                               0, 1, 2, 3, BPS)
...
// TEMP2 = SRC[C + C1 * BPS]
// TEMP3 = SRC[D + D1 * BPS]
#define LOAD_4_BYTES(TEMP0, TEMP1, TEMP2, TEMP3, A, A1, B, B1, C, C1, D, D1,   \
                     SRC)                                                      \
  "lbu      %[" #TEMP0 "],   " #A "+" #A1                                      \
  "*" XSTR(BPS) "(%[" #SRC "]) \n\t"                                           \
                "lbu      %[" #TEMP1 "],   " #B "+" #B1                        \
...
static void SimpleHFilter16(uint8_t *p, int stride, int thresh) {
  ...
  __asm__ volatile(
      ...
      "li        %[i],       16                           \n\t"
      "0:                                                   \n\t" LOAD_4_BYTES(
          temp0, temp1, temp2, temp3, -2, 0, -1, 0, 0, 0, 1, 0,
          p) "subu      %[temp7],    %[temp1],       %[temp2]    \n\t"
             "subu      %[temp6],    %[temp0],       %[temp3]    \n\t"
             "absq_s.w  %[temp4],    %[temp7]                    \n\t"
             "absq_s.w  %[temp5],    %[temp6]                    \n\t"
             "sll       %[temp4],    %[temp4],       2           \n\t"
...
static void VE4(uint8_t *dst) { // vertical
  ...
  __asm__ volatile(
      ...
      "precr.qb.ph     %[temp4],   %[temp6],    %[temp2]   \n\t" STORE_8_BYTES(
          temp4, temp4, 0, 0, 1, dst) STORE_8_BYTES(temp4, temp4, 2, 0, 3, dst)
      : [temp0] "=&r"(temp0), [temp1] "=&r"(temp1), [temp2] "=&r"(temp2),
        [temp3] "=&r"(temp3), [temp4] "=&r"(temp4), [temp5] "=&r"(temp5),
        [temp6] "=&r"(temp6)
      : [top] "r"(top), [dst] "r"(dst)
...
static void DC4(uint8_t *dst) { // DC
  ...
  __asm__ volatile(
      "ulw          %[temp0],   -1*" XSTR(BPS) "(%[dst]) \n\t" LOAD_4_BYTES(
          temp1, temp2, temp3, temp4, -1, 0, -1, 1, -1, 2, -1, 3,
...
static void RD4(uint8_t *dst) { // Down-right
  ...
  __asm__ volatile(
      LOAD_4_BYTES(
          temp0, temp1, temp2, temp3, -1, 0, -1, 1, -1, 2, -1, 3,
          dst) "ulw            %[temp7],   -1-" XSTR(BPS) "(%[dst])       \n\t"
                                                          "ins            "
                                                          "%[temp1],   "
                                                          "%[temp0], 16, 16    "
                                                          "           \n\t"
...
static void DC8uv(uint8_t *dst) { // DC
  ...
  int temp5, temp6, temp7, temp8, temp9;
  __asm__ volatile(
      LOAD_8_BYTES(temp0, temp1, -1, 4, -1, dst) LOAD_4_BYTES(
          temp2, temp3, temp4, temp5, -1, 0, -1, 1, -1, 2, -1, 3, dst)
          LOAD_4_BYTES(
              temp6, temp7, temp8, temp9, -1, 4, -1, 5, -1, 6, -1, 7,
              dst) "raddu.w.qb   %[temp0],   %[temp0]                   \n\t"
                   ...
                   "\n\t" STORE_8_BYTES(temp0, temp0, 0, 4, 0, dst)
                       STORE_8_BYTES(temp0, temp0, 1, 4, 1, dst) STORE_8_BYTES(
                           temp0, temp0, 2, 4, 2,
                           dst) STORE_8_BYTES(temp0, temp0, 3, 4, 3, dst)
  ...
  __asm__ volatile(
      LOAD_8_BYTES(
          ...
          dst) "raddu.w.qb   %[temp0],   %[temp0]                   \n\t"
               ...
               "replv.qb     %[temp0],   %[temp0]                   "
               "\n\t" STORE_8_BYTES(temp0, temp0, 0, 4, 0, dst)
                   STORE_8_BYTES(temp0, temp0, 1, 4, 1,
                                 dst) STORE_8_BYTES(temp0, temp0, 2, 4, 2, dst)
...
static void DC8uvNoTop(uint8_t *dst) { // DC with no top samples
  ...
  __asm__ volatile(
      LOAD_4_BYTES(temp2, temp3, temp4, temp5, -1, 0, -1, 1, -1, 2, -1, 3, dst)
          LOAD_4_BYTES(
              temp6, temp7, temp8, temp1, -1, 4, -1, 5, -1, 6, -1, 7,
              dst) "addu         %[temp2],   %[temp2],    %[temp3]      \n\t"
                   "addu         %[temp4],   %[temp4],    %[temp5]      \n\t"
                   "addu         %[temp6],   %[temp6],    %[temp7]      \n\t"
