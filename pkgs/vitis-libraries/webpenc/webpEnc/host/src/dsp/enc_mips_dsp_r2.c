...
#define ADD_SUB_HALVES_X4(O0, O1, O2, O3, O4, O5, O6, O7, I0, I1, I2, I3, I4,  \
                          I5, I6, I7)                                          \
  "addq.ph          %[" #O0 "],   %[" #I0 "],  %[" #I1 "]     \n\t"            \
  "subq.ph          %[" #O1 "],   %[" #I0 "],  %[" #I1 "]     \n\t"            \
  "addq.ph          %[" #O2 "],   %[" #I2 "],  %[" #I3 "]     \n\t"            \
...
// O - output
// I - input (macro doesn't change it)
#define MUL_HALF(O0, I0, I1, I2, I3, I4, I5, I6, I7, I8, I9, I10, I11, I12,    \
                 I13, I14, I15)                                                \
  "mult            $ac0,      $zero,     $zero              \n\t"              \
  "dpa.w.ph        $ac0,      %[" #I2 "],  %[" #I0 "]       \n\t"              \
  "dpax.w.ph       $ac0,      %[" #I5 "],  %[" #I6 "]       \n\t"              \
          ...
          HORIZONTAL_PASS(1, temp4, temp5, temp6, temp7)
              HORIZONTAL_PASS(2, temp8, temp9, temp10, temp11) HORIZONTAL_PASS(
                  ...
                  temp15) "lw            %[temp20],     8(%[args])             "
                          "     \n\t" VERTICAL_PASS(0, 8, 16, 24, temp0, temp4,
                                                    temp8, temp12)
                              VERTICAL_PASS(2, 10, 18, 26, temp1, temp5, temp9,
                                            temp13)
                                  VERTICAL_PASS(4, 12, 20, 28, temp2, temp6,
                                                temp10, temp14)
                                      VERTICAL_PASS(6, 14, 22, 30, temp3, temp7,
                                                    temp11, temp15)
...
static WEBP_INLINE void ITransformOne(const uint8_t *ref, const int16_t *in,
  ...
  __asm__ volatile(
      "ulw              %[temp1],   0(%[in])                 \n\t"
      "ulw              %[temp2],   16(%[in])                \n\t" LOAD_IN_X2(
          temp5, temp6, 24, 26) ADD_SUB_HALVES(temp3, temp4, temp1, temp2)
          LOAD_IN_X2(temp1, temp2, 8, 10) MUL_SHIFT_SUM(
              temp7, temp8, temp9, temp10, temp11, temp12, temp13, temp14,
              temp10, temp8, temp9, temp7, temp1, temp2, temp5, temp6, temp13,
              ...
              INSERT_HALF_X2(
                  ...
                  temp9) "ulw              %[temp17],  4(%[in])                "
                         ...
                         " \n\t" ADD_SUB_HALVES(
                             temp1, temp2, temp3,
                             temp8) ADD_SUB_HALVES(temp5, temp6, temp4, temp7)
                             ADD_SUB_HALVES(temp7, temp8, temp17, temp18)
                                 LOAD_IN_X2(temp17, temp18, 12, 14) LOAD_IN_X2(
                                     temp9, temp10, 28, 30)
                                     MUL_SHIFT_SUM(
                                         temp11, temp12, temp13, temp14, temp15,
                                         temp16, temp4, temp17, temp12, temp14,
                                         temp11, temp13, temp17, temp18, temp9,
                                         temp10, temp15, temp4, temp16, temp17)
                                         INSERT_HALF_X2(temp11, temp12, temp13,
                                                        temp14)
                                             ADD_SUB_HALVES(temp17, temp8,
                                                            temp8, temp11)
                                                 ADD_SUB_HALVES(temp3, temp4,
                                                                temp7, temp12)

      // horizontal
      SRA_16(temp9, temp10, temp11, temp12, temp1, temp2, temp5,
             temp6) INSERT_HALF_X2(temp1, temp6, temp5, temp2)
          SRA_16(temp13, temp14, temp15, temp16, temp3, temp4, temp17, temp8) "repl.ph          %[temp2],   0x4                      \n\t" INSERT_HALF_X2(
              ...
              temp4) "addq.ph          %[temp1],   %[temp1],  %[temp2]      "
                     ...
                     "\n\t" ADD_SUB_HALVES(
                         temp2, temp4, temp1,
                         temp3) ADD_SUB_HALVES(temp5, temp7, temp6, temp8)
                         MUL_SHIFT_SUM(temp1, temp3, temp6, temp8, temp9,
                                       temp13, temp17, temp18,
                                       temp3, temp13,
                                       temp1, temp9, temp9, temp13, temp11,
                                       temp15, temp6, temp17,
                                       temp8, temp18)
                             MUL_SHIFT_SUM(
                                 temp6, temp8,
                                 temp18, temp17, temp11, temp15,
                                 temp12, temp16, temp8, temp15, temp6,
                                 temp11, temp12, temp16, temp10,
                                 temp14, temp18, temp12, temp17,
                                 temp16) INSERT_HALF_X2(temp1, temp3, temp9,
                                                        temp13)
                                 INSERT_HALF_X2(temp6, temp8, temp11, temp15)
                                     SHIFT_R_SUM_X2(
                                         ...
                                         temp15,
                                         temp16,
                                         temp2, temp4, temp5, temp7, temp3,
                                         temp1, temp8, temp6)
                                         PACK_2_HALVES_TO_WORD(
                                             temp1, temp2, temp3, temp4,
                                             temp9, temp12, temp13, temp16,
                                             temp11,
                                             temp10,
                                             temp15,
                                             temp14)
...
static int Disto4x4(const uint8_t *const a, const uint8_t *const b,
  ...
  __asm__ volatile(
      LOAD_WITH_OFFSET_X4(temp1, temp2, temp3, temp4, a, 0, 0, 0, 0, 0, 1, 2, 3,
                          BPS) CONVERT_2_BYTES_TO_HALF(temp5, temp6, temp7,
                                                       temp8, temp9, temp10,
                                                       temp11, temp12, temp1,
                                                       temp2, temp3, temp4)
          ADD_SUB_HALVES_X4(
              temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp5,
              temp6, temp7, temp8, temp9, temp10, temp11,
              temp12) PACK_2_HALVES_TO_WORD(temp9, temp10, temp11, temp12,
                                            temp1, temp3, temp5, temp7, temp2,
                                            temp4, temp6, temp8)
              ADD_SUB_HALVES_X4(temp2, temp4, temp6, temp8, temp9, temp1, temp3,
                                temp10, temp1, temp9, temp3, temp10, temp5,
                                temp11, temp7, temp12)
                  ADD_SUB_HALVES_X4(
                      temp5, temp11, temp7, temp2, temp9, temp3, temp6, temp12,
                      temp2, temp9, temp6, temp3, temp4, temp1, temp8,
                      temp10) ADD_SUB_HALVES_X4(temp1, temp4, temp10, temp8,
                                                temp7, temp11, temp5, temp2,
                                                temp5, temp7, temp11, temp2,
                                                temp9, temp6, temp3, temp12)
                      ABS_X8(temp1, temp4, temp10, temp8, temp7, temp11, temp5,
                             temp2) LOAD_WITH_OFFSET_X4(temp3, temp6, temp9,
                                                        temp12, w, 0, 4, 8, 12,
                                                        0, 0, 0, 0, 0)
                          LOAD_WITH_OFFSET_X4(
                              temp13, temp14, temp15, temp16, w, 0, 4, 8, 12, 1,
                              1, 1, 1, 16) MUL_HALF(temp17, temp1, temp2, temp3,
                              ...
                              LOAD_WITH_OFFSET_X4(temp1, temp2, temp3, temp4, b,
                                                  0, 0, 0, 0, 0, 1, 2, 3, BPS)
                                  CONVERT_2_BYTES_TO_HALF(temp5, temp6, temp7,
                                                          temp8, temp9, temp10,
                                                          temp11, temp12, temp1,
                                                          temp2, temp3, temp4)
                                      ADD_SUB_HALVES_X4(temp1, temp2, temp3,
                                                        temp4, temp5, temp6,
                                                        temp7, temp8, temp5,
                                                        temp6, temp7, temp8,
                                                        temp9, temp10, temp11,
                                          ...
                                          PACK_2_HALVES_TO_WORD(
                                              ...
                                              ADD_SUB_HALVES_X4(
                                                  ...
                                                  temp6, temp8,
                                                  temp9, temp1,
                                                  temp3, temp10, temp1, temp9,
                                                  temp3, temp10, temp5, temp11,
                                                  temp7, temp12)
                                                  ADD_SUB_HALVES_X4(
                                                      temp5, temp11, temp7,
                                                      temp2, temp9, temp3,
  ...
  do {                                                                         \
    ...
    __asm__ volatile(                                                          \
        "replv.qb   %[value],  %[value]                      \n\t" FILL_PART(  \
            0, SIZE) FILL_PART(1, SIZE) FILL_PART(2, SIZE) FILL_PART(3, SIZE)  \
            FILL_PART(4, SIZE) FILL_PART(5, SIZE) FILL_PART(6, SIZE)           \
                FILL_PART(                                                     \
                    7,                                                         \
                    SIZE) ".if " #SIZE                                         \
                          " == 16                                   "          \
                          "\n\t" FILL_PART(8, 16) FILL_PART(9, 16) FILL_PART(  \
                              10, 16) FILL_PART(11, 16) FILL_PART(12, 16)      \
                              FILL_PART(13, 16) FILL_PART(14, 16) FILL_PART(   \
                                  15, 16) ".endif                            " \
                                          "                    \n\t"           \
        : [value] "+&r"(value)                                                 \
        : [dst] "r"((DST))                                                     \
    ...
    __asm__ volatile("replv.ph        %[leftY_1], %[leftY_1]              "    \
                     ...
                     "\n\t" CLIPPING() "usw             %[temp0],   "          \
                                       ...
                                       "\n\t" CLIPPING() "usw             "    \
                                                         ...
                                                         "                "    \
                                                         "\n\t"                \
                     : [leftY_1] "+&r"(leftY_1), [temp0] "=&r"(temp0),         \
...
#define TRUE_MOTION(DST, LEFT, TOP, SIZE)                                      \
  static WEBP_INLINE void TrueMotion##SIZE(                                    \
      uint8_t *(DST), const uint8_t *(LEFT), const uint8_t *(TOP)) {           \
    if ((LEFT) != NULL) {                                                      \
      if ((TOP) != NULL) {                                                     \
...
static WEBP_INLINE void DCMode16(uint8_t *dst, const uint8_t *left,
  ...
  __asm__ volatile(
      "beqz        %[top],   2f                  \n\t" LOAD_WITH_OFFSET_X4(
          temp0, temp1, temp2, temp3, top, 0, 4, 8, 12, 0, 0, 0, 0,
          0) "raddu.w.qb  %[temp0], %[temp0]            \n\t"
             ...
             "beqz        %[left],  1f                  "
             "\n\t" LOAD_WITH_OFFSET_X4(
                 temp0, temp1, temp2, temp3, left, 0, 4, 8, 12, 0, 0, 0, 0,
                 0) "raddu.w.qb  %[temp0], %[temp0]            \n\t"
                    "raddu.w.qb  %[temp1], %[temp1]            \n\t"
                    "raddu.w.qb  %[temp2], %[temp2]            \n\t"
                    "raddu.w.qb  %[temp3], %[temp3]            \n\t"
                    ...
                    "beqz        %[left],  4f                  "
                    "\n\t" LOAD_WITH_OFFSET_X4(
                        temp0, temp1, temp2, temp3, left, 0, 4, 8, 12, 0, 0, 0,
                        0, 0) "raddu.w.qb  %[temp0], %[temp0]            \n\t"
                              "raddu.w.qb  %[temp1], %[temp1]            \n\t"
                              "raddu.w.qb  %[temp2], %[temp2]            \n\t"
                              "raddu.w.qb  %[temp3], %[temp3]            \n\t"
                              "addu        %[temp0], %[temp0], %[temp1]  \n\t"
...
static void Intra16Preds(uint8_t *dst, const uint8_t *left,
                         const uint8_t *top) {
...
static int SSE16x16(const uint8_t *a, const uint8_t *b) {
  ...
  __asm__ volatile(
      "mult   $zero,    $zero                            \n\t" GET_SSE(
          ...
          12 + 0 * BPS) GET_SSE(1 * BPS, 4 + 1 * BPS, 8 + 1 * BPS,
                                12 + 1 * BPS) GET_SSE(2 * BPS, 4 + 2 * BPS,
                                                      8 + 2 * BPS, 12 + 2 * BPS)
          GET_SSE(3 * BPS, 4 + 3 * BPS, 8 + 3 * BPS, 12 + 3 * BPS) GET_SSE(
              4 * BPS, 4 + 4 * BPS, 8 + 4 * BPS,
              12 + 4 * BPS) GET_SSE(5 * BPS, 4 + 5 * BPS, 8 + 5 * BPS,
                                    12 + 5 * BPS) GET_SSE(6 * BPS, 4 + 6 * BPS,
                                                          8 + 6 * BPS,
                                                          12 + 6 * BPS)
              GET_SSE(7 * BPS, 4 + 7 * BPS, 8 + 7 * BPS, 12 + 7 * BPS) GET_SSE(
                  8 * BPS, 4 + 8 * BPS, 8 + 8 * BPS,
                  12 + 8 * BPS) GET_SSE(9 * BPS, 4 + 9 * BPS, 8 + 9 * BPS,
                                        12 + 9 * BPS)
                  GET_SSE(10 * BPS, 4 + 10 * BPS, 8 + 10 * BPS,
                          12 + 10 * BPS) GET_SSE(11 * BPS, 4 + 11 * BPS,
                                                 8 + 11 * BPS, 12 + 11 * BPS)
                      GET_SSE(12 * BPS, 4 + 12 * BPS, 8 + 12 * BPS,
                              12 + 12 * BPS) GET_SSE(13 * BPS, 4 + 13 * BPS,
                                                     8 + 13 * BPS,
                                                     12 + 13 * BPS)
                          GET_SSE(14 * BPS, 4 + 14 * BPS, 8 + 14 * BPS,
                                  12 + 14 * BPS)
                              GET_SSE(
                                  15 * BPS, 4 + 15 * BPS,
                                  8 + 15 * BPS,
...
static int SSE16x8(const uint8_t *a, const uint8_t *b) {
  ...
  __asm__ volatile(
      "mult   $zero,    $zero                            \n\t" GET_SSE(
          0 * BPS, 4 + 0 * BPS, 8 + 0 * BPS,
          12 + 0 * BPS) GET_SSE(1 * BPS, 4 + 1 * BPS, 8 + 1 * BPS, 12 + 1 * BPS)
...
static int QuantizeBlock(int16_t in[16], int16_t out[16],
  ...
  __asm__ volatile(
      QUANTIZE_ONE(0, 0, 0, 2) QUANTIZE_ONE(4, 8, 10, 12)
          QUANTIZE_ONE(8, 16, 4, 8) QUANTIZE_ONE(12, 24, 14, 24)
              QUANTIZE_ONE(16, 32, 6, 16) QUANTIZE_ONE(20, 40, 22, 26)
...
static void FTransformWHT(const int16_t *in, int16_t *out) {
  ...
  __asm__ volatile(
      HORIZONTAL_PASS_WHT(0, 32, 64, 96, temp0, temp1) HORIZONTAL_PASS_WHT(
          128, 160, 192, 224, temp2,
          temp3) HORIZONTAL_PASS_WHT(256, 288, 320, 352, temp4, temp5)
...
static void CollectHistogram(const uint8_t *ref, const uint8_t *pred,
  ...
  for (j = start_block; j < end_block; ++j) {
    ...
    __asm__ volatile(
        CONVERT_COEFFS_TO_BIN(0, 4, 8, 12) CONVERT_COEFFS_TO_BIN(16, 20, 24, 28)
        : [temp0] "=&r"(temp0), [temp1] "=&r"(temp1), [temp2] "=&r"(temp2),
          [temp3] "=&r"(temp3), [temp4] "=&r"(temp4), [temp5] "=&r"(temp5),
          [temp6] "=&r"(temp6), [temp7] "=&r"(temp7), [temp8] "=&r"(temp8)
