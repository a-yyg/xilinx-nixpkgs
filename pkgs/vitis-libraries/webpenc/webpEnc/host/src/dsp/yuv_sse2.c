...
static void ConvertYUV444ToRGB(const __m128i *const Y0, const __m128i *const U0,
...
static void YUV444ToRGB(const uint8_t *const y, const uint8_t *const u,
                        const uint8_t *const v, __m128i *const R,
                        __m128i *const G, __m128i *const B) {
...
static void YUV420ToRGB(const uint8_t *const y, const uint8_t *const u,
                        const uint8_t *const v, __m128i *const R,
                        __m128i *const G, __m128i *const B) {
...
RGB24PackedToPlanarHelper(const __m128i *const in /*in[6]*/,
                          __m128i *const out /*out[6]*/) {
...
static void ConvertRGBA32ToUV(const uint16_t *rgb, uint8_t *u, uint8_t *v,
                              int width) {
  const int max_width = width & ~15;
