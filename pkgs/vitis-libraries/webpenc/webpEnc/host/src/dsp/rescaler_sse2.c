...
LoadDispatchAndMult(const rescaler_t *const src, const __m128i *const mult,
...
static WEBP_INLINE void
ProcessRow(const __m128i *const A0, const __m128i *const A1,
           const __m128i *const A2, const __m128i *const A3,
           const __m128i *const mult, uint8_t *const dst) {
  const __m128i rounder = _mm_set_epi32(0, ROUNDER, 0, ROUNDER);
