...
#define LOAD_WITH_OFFSET_X4(O0, O1, O2, O3, I0, I1, I2, I3, I4, I5, I6, I7,    \
                            I8, I9)                                            \
  "ulw    %[" #O0 "],    " #I1                                                 \
  "+" XSTR(I9) "*" #I5 "(%[" #I0 "])       \n\t"                               \
               "ulw    %[" #O1 "],    " #I2                                    \
...
// IO - input/output
// I - input (macro doesn't change it)
#define MUL_SHIFT_SUM(O0, O1, O2, O3, O4, O5, O6, O7, IO0, IO1, IO2, IO3, I0,  \
...
// O - output
// I - input (macro doesn't change it)
#define SHIFT_R_SUM_X2(O0, O1, O2, O3, O4, O5, O6, O7, I0, I1, I2, I3, I4, I5, \
                       I6, I7)                                                 \
  "addq.ph          %[" #O0 "],   %[" #I0 "],   %[" #I4 "]    \n\t"            \
  "subq.ph          %[" #O1 "],   %[" #I0 "],   %[" #I4 "]    \n\t"            \
  "addq.ph          %[" #O2 "],   %[" #I1 "],   %[" #I5 "]    \n\t"            \
...
// IO - input/output
// I - input (macro doesn't change it)
#define PACK_2_HALVES_TO_WORD(O0, O1, O2, O3, IO0, IO1, IO2, IO3, I0, I1, I2,  \
                              I3)                                              \
...
// O - output
// I - input (macro doesn't change it)
#define CONVERT_2_BYTES_TO_HALF(O0, O1, O2, O3, O4, O5, O6, O7, I0, I1, I2,    \
                                I3)                                            \
  "preceu.ph.qbr    %[" #O0 "],   %[" #I0 "]                      \n\t"        \
  "preceu.ph.qbl    %[" #O1 "],   %[" #I0 "]                      \n\t"        \
  "preceu.ph.qbr    %[" #O2 "],   %[" #I1 "]                      \n\t"        \
...
// IO - input/output
// I - input (macro doesn't change it)
#define STORE_SAT_SUM_X2(IO0, IO1, IO2, IO3, IO4, IO5, IO6, IO7, I0, I1, I2,   \
