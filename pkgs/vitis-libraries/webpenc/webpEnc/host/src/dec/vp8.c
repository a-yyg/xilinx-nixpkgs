...
static int ParseResiduals(VP8Decoder *const dec, VP8MB *const mb,
  ...
  if (!block->is_i4x4_) { // parse DC
    ...
    if (nz > 1) { // more than just the DC -> perform the full transform
      ...
      // StopProfiling(&stop_watch_VP8TransformWHT, &timeVP8TransformWHT,
      // &countVP8TransformWHT);
  ...
  // StopProfiling(&stop_watch_if1, &timeParseResidualsIf1,
  // &countParseResidualsIf1);
  ...
  out_t_nz = tnz;
  out_l_nz = lnz >> 4;
  // StopProfiling(&stop_watch_loop1, &timeParseResidualsLoop1,
  // &countParseResidualsLoop1);
  ...
  // StopProfiling(&stop_watch_loop2, &timeParseResidualsLoop2,
  // &countParseResidualsLoop2);
